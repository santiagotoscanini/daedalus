...
// behind every row.
//
// Why it is a Home tab: it is not traefik's (that is infrastructure with a
// release cycle; this is the account every person in the house signs in
// with), and it is not a subject of its own — beside the automation, the
// photos and the files it is one of the household's things. Its join with the
// proxy is one column on Network's routing table.
