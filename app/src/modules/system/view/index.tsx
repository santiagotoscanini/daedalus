...
//
// No ServiceHead on the layer tabs, unlike Media and Home: there is no
// service to name, no version to compare and no UI to open (Claude and
// Shotter, which are services, keep theirs). The subject is the box, so each
// tab opens straight into the panel that answers its question. That is
// declared per tab in the manifest (`head: false`) rather than merely omitted
// here, because the SKELETON has to know it before the data exists — see the
// note there.
//
